...
define(function(require, exports, module) {
    ...
    var orderprocess = {
        ...
        Reg: {
            ...
            checkEnNameNew: function (str) {
                if ('' === str)
                    return [false, "请输入英文/拼音"];
                if (/[^a-zA-Z. \/'-]/.test(str))
                    return [false, "英文姓名中包含非法字符，请检查"];
                if (/[^a-zA-Z]/.test(str))
                    return [false, "英文的姓名中只能包含字母"];
                if (!/^[a-zA-Z]/.test(str))
            ...
            checkIdCard: function(str, type) {
                ...
                if (type === 1) {
                    if (!/^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[a-zA-Z])$/.test(str))
        ...
        tpl: { //模板
            ...
            traveller: '{{#each list}}\
                      <div class="product_input product_input_border layoutfix" ptype="{{#if isAdult}}1{{else}}0{{/if}}" filled="{{filled}}" index="{{clientID}}" role="youren">\
                        ...
                        {{#if UserName}}\
                            ...
                            <li>\
                                ...
                                <input type="text" class="input_m cq" _cqnotice="证件的姓名" value="{{#if ../../nameCN}}{{../../nameCN}}{{else}}{{../../ENLastName}}{{#if ../../ENLastName}}/{{/if}}{{../../ENFirstName}} {{../../ENMiddleName}}{{/if}}" role="name" regex="checkName"/>\
                        ...
                        {{#if ChineseName}}\
                            ...
                            <li>\
                                <label for="" class="product_label">{{Name}}</label>\
                                <input type="text" class="input_m cq" _cqnotice="证件的中文姓名" value="{{../../nameCN}}" role="nameCN" regex="checkCnName"/>\
                        ...
                        {{#if EnglishName}}\
                            ...
                            <li class="optional">\
                                <label for="" class="product_label">{{Name}}</label>\
                                <input type="text" class="input_englishname cq" _cqnotice="姓（拼音或英文）" value="{{#if ../../ENLastName}}{{../../ENLastName}}{{/if}}" role="nameEnLast" regex="checkEnNameLast"/>\
                                <input type="text" class="input_englishname input_engnomar cq" _cqnotice="名（拼音或英文）" value="{{#if ../../ENFirstName}}{{../../ENFirstName}}{{#if ../../ENMiddleName}} {{../../ENMiddleName}}{{/if}}{{/if}}" role="nameEnFirst" regex="checkEnNameFirst" />\
                        ...
                        {{#if Nationality}}\
                            ...
                            <li class="optional later" style={{#equal ../../IDCardType 1 "display:none" ""}}{{/equal}}>\
                                <label for="" class="product_label">{{Name}}</label>\
                                <input mod_value="{{../../national}}" type="text" value="{{../../national}}" regex="checkNationality" role="national" class="input_m cq nationality" _cqnotice="中文/拼音"/>\
                            </li>\
                            {{/with}}\
                        {{/if}}\
                        {{#if IDType}}\
                            ...
                            <li>\
                                ...
                                <input type="text" value="{{../../IDCardNo}}" role="idCardNo" class="input_s later cq" regex="checkIdCard" _cqnotice="证件号码" note="{{../../restrictions}}"/>\
                        ...
                        {{#if CardValidUntil}}\
                            ...
                            <li class="optional later" style={{#equal ../../IDCardType 1 "display:none" ""}}{{/equal}}>\
                                <label for="" class="product_label">{{Name}}</label>\
                                <input type="text" value="{{../../IDCardTimelimitY}}" class="all_field_width cq"  role="cardValidUntilY" _cqnotice="yyyy" style="" regex="checkCardValidUntil">&nbsp;-&nbsp;<input type="text" value="{{../../IDCardTimelimitM}}" class="all_field_width cq" role="cardValidUntilM" _cqnotice="mm" style="" regex="checkCardValidUntil">&nbsp;-&nbsp;<input type="text" value="{{../../IDCardTimelimitD}}" role="cardValidUntilD" class="all_field_width cq"  _cqnotice="dd" regex="checkCardValidUntil">\
                            </li>\
                            {{/with}}\
                        {{/if}}\
                        {{#if Sex}}\
                            {{#with Sex}}\
                             <li class="optional" style={{#equal ../../IDCardType 1 "display:none" ""}}{{/equal}}>\
                                <label for="" class="product_label">{{Name}}</label>\
                                <select name="" value="{{../gender}}" role="gender" regex="checkSex">\
                        ...
                        {{#with Birthday}}\
                            <li class="optional later" style={{#equal ../../IDCardType 1 "display:none" ""}}{{/equal}}>\
                                <label for="" class="product_label">{{Name}}</label>\
                                <input type="text" value="{{../../birthdayY}}" class="all_field_width cq" regex="checkBirthday"  role="birthdayY" _cqnotice="yyyy" style="">&nbsp;-&nbsp;<input type="text" value="{{../../birthdayM}}" class="all_field_width cq" regex="checkBirthday" role="birthdayM"  _cqnotice="mm" style="">&nbsp;-&nbsp;<input type="text" value="{{../../birthdayD}}" role="birthdayD" class="all_field_width cq" regex="checkBirthday"  _cqnotice="dd">\
                            </li>\
                        {{/with}}\
                        {{/if}}\
                        {{#if BirthPlace}}\
                        ...
                        <li class="optional later" style={{#equal ../../IDCardType 1 "display:none" ""}}{{/equal}}>\
                            <label for="" class="product_label">{{Name}}</label>\
                            <input type="text" value="{{../../HomePlace}}" role="birthPlace" class="input_m" regex="checkBirthPlace"/>\
                        </li>\
                        {{/with}}\
                        {{/if}}\
                        {{#if ContactPhone}}\
                        ...
                        <li>\
                            ...
                            <input type="text" class="input_m" value="{{../../mobileNo}}" role="mobileNo" class="" regex="checkMobile"/>\
                   ...
                   {{/each}}',
            linkmanBox: '<ul class="input_box" role="contact">\
            ...
            linkmanDf: '<ul class="input_box contact_info">\
                        <li class="point">为方便携程及时与您联系，请准确填写联系人信息（手机号码，Email）</li>\
                        <li class="default">\
                                                  ...
                                                  <h2><a href="###" alt="" id="js_book_masking_close"></a>资源信息提示</h2>\
                                                    <div class="book_masking_padding">\
                                                        <div class="book_masking_content">\
                                                            <i class="icon_no"></i>\
                                                            <h3>{{#if data}}{{data}}{{/if}}\
                                                                {{#if cheapen}}好消息！舱房总价调整为<span class="num" style="font-weight:bold;color:#ff9913">{{cheapen}}</span>元了。<br><span class="text_deep" style="color:#000">此时不抢，更待何时！</span>{{/if}}\
                                                                {{#if rise}}真抱歉！舱房总价调整为<span class="num" style="font-weight:bold;color:#ff9913">{{rise}}</span>元了。{{/if}}\
                                                            </h3>\
                            ...
                            if (self.status.errorElem) {
                                ...
                                return false;
                                 ...
                                 $.ajax({
                                    ...
                                    data:"TmpOrderID=" + GV.app.order.vars.initData.orderid + "&productID=" + GV.app.order.vars.initData.productID + "&customerInfo=" + cQuery.stringifyJSON(customerInfo),
                                    timeout:120000,
                                    type: "POST",
                                       ...
                                       if(jsonData.isSkipFAVCheck) bookParameter += "&isSkipFAVCheck=" + jsonData.isSkipFAVCheck;
                                         if (jsonData.data && jsonData.data.length > 0) {
                                            ...
                                            self.events.save.call(self, !0, self.formData.TempOrderType != 0)();
                                               for (var i = 0, len = jsonData.data.length; i < len; i++) {
                                                ...
                                                for (var j = 0, lens = bookingHandleData.length; j < lens; j++) {
                                                   ...
                                                   /*新增类型*/
                                                   else if(bookingHandleData[j].Type == 101 || bookingHandleData[j].Type == 201 ||bookingHandleData[j].Type == 301 || bookingHandleData[j].Type == 401 || bookingHandleData[j].Type == 102 || bookingHandleData[j].Type == 501 || bookingHandleData[j].Type == 502){
                                                     bookingDataString += "【" + bookingHandleData[j].ResourceName + "】、";
                                                   }
                                                 }
                                          ...
                                          if(jsonData.CruiseItem){
                                              if(jsonData.CruiseItem.BookingID != null) bookParameter += "&BookingID=" + jsonData.CruiseItem.BookingID;
                                              if(jsonData.CruiseItem.ResourcePrice != null && jsonData.CruiseItem.ResourcePrice != 0 && jsonData.CruiseItem.ResourcePrice != GV.app.order.vars.initData.price.Amount){
                                                  bookingJsonData.steamer = "again";
                                                 if(jsonData.CruiseItem.ResourcePrice > GV.app.order.vars.initData.price.Amount) {
                                                    bookingJsonData.rise = jsonData.CruiseItem.ResourcePrice;
                                                    bookingJsonData.other = "other";
                                                 }
                                                if(jsonData.CruiseItem.ResourcePrice < GV.app.order.vars.initData.price.Amount) {
                                                     bookingJsonData.cheapen = jsonData.CruiseItem.ResourcePrice;
                                                }
                                                     closeBooKMasking(bookingJsonData,me);
                                                     customerInfo = [];
                                                     closeBookSure();
                                    ...
                                    error:function(){
                                       bookingError(!0,me,bookParameter,!0);
                                    }
                                })
                            }
                        }
            ...
            return {
                ...
                select: function() {
                    ...
                    if (this.isSingle) {
                        ...
                        couponCHeck(_role, promotionid,!0);
                    }
            ...
            Visitor.prototype = {
              ...
              /*  forForeign: function(isForeign, isHasEnName) { //是否是外宾
                ...
                checkEnNameLast: function (str) {
                    //英文姓检测
                    return this.checkEnNameNew(str,this.role.nameEnLast);
                },
                checkEnNameFirst: function (str) {
                    //英文名检测
                    var name = $.trim(str).split(' ');
                    if (name[2]){
                        this.showTip(this.role.nameEnFirst[0],Reg.checkEnName(str)[1],{$obj:this.role.nameEnFirst[0]});
                        return false;
                    }
                    return (name[1] && this.checkEnNameNew(name[1], this.role.nameEnFirst)) || this.checkEnNameNew(name[0], this.role.nameEnFirst);
                },
                checkEnNameNew: function (str, obj) {
                    //英文单元检测
                    var role = this.role;
                    var lastNameItem = role.nameEnFirst;
                    var firstNameItem = role.nameEnLast;
                    var strs = $.trim(str) === obj.attr('_cqnotice') ? '' : $.trim(str);
                    var bl = Reg.checkEnNameNew(strs);
                    if (!bl[0]) {
                ...
                checkForeign: function (str) {
                    if (!(str === "CN" || str === "HK" || str === "MO" || str === "TW")) {
                        if (this.role.idCardType && this.role.idCardType.val() != '1') {
                            self.hideTip(this.role.nameCN[0]);
                        }
                        return false;
                    }
                    return true;
