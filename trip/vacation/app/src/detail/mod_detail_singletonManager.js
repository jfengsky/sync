define(function (require, exports, module) {
    ...
    //【团队游详情页】【优化】：将【日期、成人数、儿童数】作为key，value为这次返回的GUID，当下次再请求相同的【日期、成人数、儿童数】时，把之前的GUID附带到请求的参数中
    //////////////////////////////////
    //////////////////////////////////
    ///////////// GUID begin
    //////////////////////////////////
    ...
    exports.GUIDManager = {
        ...
        _getKey: function (BaseInfo) {
            return util.dtdate(BaseInfo.DepartureDate) + '--' + BaseInfo.AdultNum + '--' + BaseInfo.ChildNum;
        },
        /*
		* @param {Object} BaseInfo {DepartureDate, AdultNum, ChildNum}
		*/
        set: function (BaseInfo, GUID) {//date, adultCount, childCount, GUID) {
            if (GUID === null) {
	...
	*/
    GV.on('money-contain-loaded', function (FeeInfos) {
        moneyContainManager.setFeeInfos(FeeInfos);
    });
    //////////////////////////////////
    //////////////////////////////////
    ///////////// 费用包含 end
    ...
    exports.TotalPrice = inherit({
		...
		*/
        ...
        changePrice: function (newPrice, oldPrice) {
            var price = this.price - oldPrice + newPrice;
