  ...
  <div class=\"product_input product_input_border layoutfix\" ptype=\"{{#if isAdult}}1{{else}}0{{/if}}\" filled=\"{{filled}}\" index=\"{{clientID}}\" role=\"youren\">\n\
    ...
    {{#if IDType}}\n\
        ...
        <li>\n\
            ...
            <input type=\"text\" value=\"{{../../IDCardNo}}\" role=\"idCardNo\" class=\"{{#is ../InputClassType 'PkgOrderDetail.aspx'}}input_text input_s{{else}}input_s later cq{{/is}}\" regex=\"checkIdCard\" _cqnotice=\"证件号码\" note=\"{{../../restrictions}}\" />\n\
    ...
    <li>\n\
        ...
        <input type=\"text\" class=\"{{#is ../InputClassType 'PkgOrderDetail.aspx'}}input_text{{else}}input_m{{/is}}\" value=\"{{../../mobileNo}}\" role=\"mobileNo\" regex=\"checkMobile\" />\n\
