define(function(){
	...
	<li class=\"start_date\">\n\
		...
		<div class=\"input_wrap\">\n\
			{{#if isStartup}}\n\
			<input readonly type=\"text\" id=\"js-departure-date\" value=\" 请选择出发日期\">\n\
			<input readonly id=\"js-depature-date-real\" type=\"text\" style=\"position:absolute;left:0;top:0;z-index:1;filter:alpha(opacity=0);opacity:0;\" value=\"请选择出发日期\">\n\
			{{else}}\n\
            <input readonly type=\"text\" id=\"js-departure-date\" value=\"{{#if BaseInfo.DepartureDate}} {{#dtdate BaseInfo.DepartureDate}}{{/dtdate}}（{{#week BaseInfo.DepartureDate}}{{/week}}）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{#if StartPrice}}&yen;{{StartPrice}}起/{{#unless StudyTour}}成{{/unless}}人{{/if}}{{/if}}\" />\n\
            <input readonly type=\"text\" style=\"position:absolute;left:0;top:0;z-index:1;filter:alpha(opacity=0);opacity:0;\" value=\"{{#if BaseInfo.DepartureDate}}{{#dtdate BaseInfo.DepartureDate}}{{/dtdate}}{{/if}}\" />\n\
			{{/if}}\n\
			<b></b>\n\
		</div>\n\
	...
	<li class=\"tourist_num\">\n\
		<label for=\"\">成人</label>\n\
		<div class=\"input_wrap\">\n\
            <input type=\"text\" value=\"{{#is BaseInfo.AdultNum '!==' undefined}}{{BaseInfo.AdultNum}}{{else}}{{#Max MinPersonQuantity 2}}{{/Max}}{{/is}}\" />\n\
			<b></b>\n\
	...
	<li class=\"children_num\">\n\
		...
		<div class=\"input_wrap\">\n\
			<input type=\"text\" value=\"{{#is BaseInfo.ChildNum '!==' undefined}}{{BaseInfo.ChildNum}}{{else}}0{{/is}}\" />\n\
			<b></b>\n\
			<p style=\"display:none\">\n\
							...
							<div class=\"room_num\">\n\
								...
								{{#listItem Inventory 0}}\n\
									{{#is MinQuantity MaxQuantity}}\n\
                                        ...
                                        {{#if IsChooseRequired}}\n\
                                            <input type=\"text\" value=\"{{DefaultQuantity}}\" /><b></b>\n\
