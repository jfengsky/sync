...
define(function (require, exports, module) {
        ...
        var _dom = pCQueryDom,
                ...
                initData = function (pData) {
                    ...
                    var _ref = _dom.regMod('address', '1.0', {
                        ...
                        template: { filter: _templateFilter, suggestion: "" }
                    });
    ...
    Validation.ValidateForm.prototype = {
        Check: {
            required: function (pIpt) {
                ...
                return pIpt.value != null && pIpt.value != pIpt.getAttribute("data-default") && pIpt.value.replace(_regTirm, "") !== ("" || pIpt.attributes["_cqnotice"].value);
            },
    ...
    SearchPro = function () {
        ...
        var _hideBtn = document.getElementById("SearchProHideBtn"),
                ...
                _inputTexts = $panel.find("INPUT[type='text']"),
                ...
                initData = function () {
                    var me = this,
                        ...
                        _hover = function (pIptText) {
                            cQuery.mod.load('calendar', '1.1', function () {
                                cQuery(pIptText).regMod('calendar', '1.1', { options: { autoShow: false, showWeek: true },
        ...
        flightHotel: function() {
            ...
            return {
                ...
                appendJs: function() {
                    ...
                    $LAB.script({
                        src: baseUrl + '/app/min/index/FHX_search.js',
                        charset: "utf-8"
                    });
                },
                bind: function() {
    ...
    (function ($) {
        ...
        $.fn.showWaterFlow = function (options) {
            ...
            return this.each(function () {
                ...
                $.ajax({ url: curl, type: 'POST', data: curType.Arg + "&StartCity=" + ($$.StartCity || settings.startCity), timeout: 7000, success: function (responseData) {
