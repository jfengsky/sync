...
#        html += '<a href="javascript:void(0)">' + _data.totalPage + '</a>'
    ...
    @_tpl = (_data)->
      ...
      # 只1页不用显示翻页
      if _data.currentPage is 1 and _data.totalPage <= 1
        return
      ...
      # 其它页码
        ...
        html += self._tplGoto
      html += '</div>'
#      '<div class="pkg_page basefix">
#        <a href="javascript:void(0)" class="up up_nocurrent"><b></b></a>
#        <a href="javascript:void(0)" class="up"><b></b></a>
...
#        <a href="javascript:void(0)" class="down">下一页<b></b></a>
#        <a href="javascript:void(0)" class="down down_nocurrent">下一页<b></b></a>
#        <span class="pkg_pagevalue">到
#          <input type="text" class="pkg_page_num" name="">页
#          <input type="button" class="pkg_page_submit" value="确定" name="">
#        </span>
#      </div>'
