    ...
    function CountTime() {
        ...
        */
        this._noticeDayTpl = function (data) {
            return '距离<span class="actives_date">' + START_DATA + '</span>预售发布还剩<span class="remain_time_bg">' + data.d + '</span>天<span class="remain_time_bg">' + data.h + '</span>小时<span class="remain_time_bg">' + data.m + '</span>分钟</div>'
        };
        ...
        */
        this._noticeSecTpl = function (data) {
            return '距离预售发布还剩<span class="remain_time_bg">' + data.h + '</span>小时<span class="remain_time_bg">' + data.m + '</span>分钟<span class="remain_time_bg">' + data.s + '</span>秒</div>'
        };
        ...
        */
        this._preDayTpl = function (data) {
            return '距离预售结束还剩<span class="remain_time_bg">' + data.d + '</span>天<span class="remain_time_bg">' + data.h + '</span>小时<span class="remain_time_bg">' + data.m + '</span>分钟</div>'
        };
        ...
        */
        this._preSecTpl = function (data) {
            return '距离预售结束还剩<span class="remain_time_bg">' + data.h + '</span>小时<span class="remain_time_bg">' + data.m + '</span>分钟<span class="remain_time_bg">' + data.s + '</span>秒</div>'
        };
        ...
        */
        this.init = function () {
            ...
            if (currentTime >= startTime && currentTime <= endTime) {
                ...
                $('#J_main').attr('data-status', 1);
            } else {

                // 预告阶段
                self._sellNotice(currentTime, startTime);
                $('#J_main').attr('data-status', 0);
            }
        };
    }
