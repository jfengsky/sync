        ...
        tpl: { //模板
                                    ...
                                    <div class="usual_address_mod">\
                                      <ul class="usual_address_list" role="addressList" type="4">\
                                        ...
                                        <li class="usual_address_item {{#unless @index}}usual_address_item_selected{{/unless}}">\
                                          ...
                                          <a href="###" class="edit" role="adsedit" data-Recipient="{{Recipient}}" data-tel="{{#if Mobile}}{{Mobile}}{{else}}{{#if Tel}}{{Tel}}{{/if}}{{/if}}" data-CityName="{{CityName}}" data-CantonName="{{CantonName}}" data-Address="{{Address}}" data-Post="{{Post}}"><i></i>编辑</a>\
                                ...
                                <div class="delivery" style="display:none" type="1">\
                                    ...
                                    <div class="usual_address_mod">\
                                      ...
                                      {{#each inCityAddress}}\
                                        ...
                                        <p class="code">{{Post}}</p>\
                                        <i class="ico_checked"></i>\
                                        <a href="###" class="edit" role="adsedit" data-Recipient="{{Recipient}}" data-CityName="{{CityName}}" data-CantonName="{{CantonName}}" data-Address="{{Address}}" data-Post="{{Post}}"><i></i>编辑</a>\
            ...
            editAllAddress: '<div class="mask_popup" style="width:590px;display:none;" id="mask_popup">\
                                ...
                                <table class="popup_book_table">\
                                    ...
                                    <tr>\
                                        <th class="import"></th>\
                                        <td><input type="text" regex="checkDetail" class="input_m" role="detail" value="{{adress}}"></td>\
                                    </tr>\
                                    <tr style="display:none;">\
                                        <th class="import"></th>\
                                        <td>\
            ...
            editInCityAddress: '<div class="mask_popup" style="width:590px;display:none;" id="mask_popup">\
                                    <h3>填写新地址</h3>\
                                    <table class="popup_book_table">\
                                        <tbody><tr>\
                                            <th>配送地址</th>\
            ...
            return {
                ...
                bindEvent: function () {
                    ...
                    roles.deliveryID.on('click', '[role="new"]', function (event) {
                        ...
                        .on('click', 'a[role="adsedit"]', function(){    // 编辑配送地址
                            event.preventDefault();
                            var index = +$(this).closest('.delivery').attr('type');
                        ...
                        // TODO 新增配送地址
                        .on('click', 'a[role="addads"]', function(){
                            event.preventDefault();
                            var index = +$(this).closest('.delivery').attr('type');
                ...
                selectAddress: function (_role, _i, name) {
                    ...
                    var tpl1 = '<li class="usual_address_item usual_address_item_selected">' +
                                  ...
                                  '<p class="code">{{Post}}</p>' +
                                  '<i class="ico_checked"></i>' +
                                  '<a href="###" role="adsedit" class="edit" data-Recipient="{{Recipient}}" data-tel="{{#if Mobile}}{{Mobile}}{{else}}{{#if Tel}}{{Tel}}{{/if}}{{/if}}" data-CityName="{{CityName}}" data-CantonName="{{CantonName}}" data-Address="{{Address}}" data-Post="{{Post}}"><i></i>编辑</a>' +
                    ...
                    var tpl2 = '<li class="usual_address_item usual_address_item_selected">' +
                              ...
                              '<p class="code">{{Post}}</p>' +
                              '<i class="ico_checked"></i>' +
                              '<a href="###" role="adsedit" class="edit" data-Recipient="{{Recipient}}" data-CityName="{{CityName}}" data-CantonName="{{CantonName}}" data-Address="{{Address}}" data-Post="{{Post}}"><i></i>编辑</a>' +
