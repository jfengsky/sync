...
define(function (require, exports, module) {
    ...
    var HotDest = {
        common: { //公用的函数
            ...
            fetchData: function (opts, cb) { //ajax
                ...
                $.ajax({
                    ...
                    beforeSend: opts.before || function () { },
                    // timeout : 5000,
            ...
            channelHotJmp: '<div {{#if Right.PicUrl}}class="channel_hot_jmp"{{else}}class="channel_hot_jmp hot_no_pic"{{/if}} style="display:none; top:0;">\
                        ...
                        <div class="channel_jmp_img_wrap">\
                            ...
                            <a href="{{trimUrl SubjectUrl}}" target="_blank">\
                                <img src="" data-src="{{trimUrl PicUrl}}" class="channel_jmp_img" alt="" style="display:none;" />\
                            </a>\
                            {{else}}\
                            <img src="" data-src="{{trimUrl PicUrl}}" class="channel_jmp_img" alt="" style="display:none;" />\
                            {{/if}}\
            ...
            return {
                ...
                */
                _lazyShowImg: function (jSubitem) {
                    var jImg = jSubitem.find('img.channel_jmp_img');
        ...
        */
        setHref: function () {
            if ($(".pkg-hot-list").length == 0) return;
        ...
        init: function () {
            if ($('.priceTest')) {
				...
				if($("#SearchProHideBtn")){
					$("#SearchProHideBtn").bind("click", function () {
