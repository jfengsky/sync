...
if(!global.g_adsconfig){global.g_adsconfig = "";}
  ...
  // 旅游广告页面信息点布点
  window.adCookieDomain = 'ctrip.com/'; 
  $LAB.script("http://webresource.c-ctrip.com/ResCRMOnline/r1/js/index/aCookie.min.js?20140420temp");
  ...
  VA.VAD = function (pageid){
    ...
    var config = {
      ...
      'map': {
        ...
        '2-2': ['PanelAdBanner|2127-2128-2129'],
        '2-3': ['PanelAdBanner|2170-2171-2172'],
        '2-4': ['PanelAdBanner|2213-2214-2215'],
        '2-5': ['PanelAdBanner|2256-2257-2258'],
        '2-6': ['PanelAdBanner|2299-2300-2301'],
        '2-7': ['PanelAdBanner|1740-1741-1742'],
        '2-8': ['PanelAdBanner|2342-2343-2344'],
        '2-9': ['PanelAdBanner|1697-1698-1699'],
        '2-10': ['PanelAdBanner|1783-1784-1785'],
        '2-11': ['PanelAdBanner|1826-1827-1828'],
        '2-12': ['PanelAdBanner|1869-1870-1871'],
        '2-13': ['PanelAdBanner|1998-1999-2000'],
        '2-14': ['PanelAdBanner|1955-1956-1957'],
        '2-15': ['PanelAdBanner|1912-1913-1914'],
        '2-16': ['PanelAdBanner|2084-2085-2086'],
        '2-17': ['PanelAdBanner|2385-2386-2387'],
        '2-18': ['PanelAdBanner|2041-2042-2043'],

        '3-1': ['PanelAdBanner|1660-1661-1662', 'divJZAD1|1663', 'divJZAD2|1664', 'divJZAD3|1665'],
        '3-2': ['PanelAdBanner|2133-2134-2135'],
        '3-3': ['PanelAdBanner|2176-2177-2178'],
        '3-4': ['PanelAdBanner|2219-2220-2221'],
        '3-5': ['PanelAdBanner|2262-2263-2264'],
        '3-6': ['PanelAdBanner|2305-2306-2307'],
        '3-7': ['PanelAdBanner|1746-1747-1748'],
        '3-8': ['PanelAdBanner|2348-2349-2350'],
        '3-9': ['PanelAdBanner|1703-1704-1705'],
        '3-10': ['PanelAdBanner|1789-1790-1791'],
        '3-11': ['PanelAdBanner|1832-1833-1834'],
        '3-12': ['PanelAdBanner|1875-1876-1877'],
        '3-13': ['PanelAdBanner|2004-2005-2006'],
        '3-14': ['PanelAdBanner|1961-1962-1963'],
        '3-15': ['PanelAdBanner|1918-1919-1920'],
        '3-16': ['PanelAdBanner|2090-2091-2092'],
        '3-17': ['PanelAdBanner|2391-2392-2393'],
        '3-18': ['PanelAdBanner|2047-2048-2049'],
        ...
        '11-1': ['PanelAdBanner|2740-2741-2742'],
        '11-2': ['PanelAdBanner|2740-2741-2742'],
        '11-3': ['PanelAdBanner|2740-2741-2742'],
        '11-4': ['PanelAdBanner|2740-2741-2742'],
        '11-5': ['PanelAdBanner|2740-2741-2742'],
        '11-6': ['PanelAdBanner|2740-2741-2742'],
        '11-7': ['PanelAdBanner|2740-2741-2742'],
        '11-8': ['PanelAdBanner|2740-2741-2742'],
        '11-9': ['PanelAdBanner|2740-2741-2742'],
        '11-10': ['PanelAdBanner|2740-2741-2742'],
        '11-11': ['PanelAdBanner|2740-2741-2742'],
        '11-12': ['PanelAdBanner|2740-2741-2742'],
        '11-13': ['PanelAdBanner|2740-2741-2742'], // nanjing /jiangsu
        '11-14': ['PanelAdBanner|2740-2741-2742'], // hangzhou / zhejiang
        '11-15': ['PanelAdBanner|2740-2741-2742'],
        '11-16': ['PanelAdBanner|2740-2741-2742'], // chengdu / xinan
        '11-17': ['PanelAdBanner|2740-2741-2742'],
        '11-18': ['PanelAdBanner|2740-2741-2742']
      }
    };
