...
<div class=\"order_mod order_passenger\" id=\"js-passenger\">\n\
        ...
        <dl class=\"mod_list\" ptype=\"{{#if isAdult}}1{{else}}0{{/if}}\">\n\
            ...
            <dd>\n\
                <table class=\"crosswise_tb\" width=\"100%\">\n\
                    ...
                    <tr>\n\
                        ...
                        <td>\n\
                            {{#each ../idOptions}}\n\
                                ...
                                {{/is}}\n\
                            {{/each}}\n\
                            <span class=\"J_cardno\">{{../../IDCardNo}}</span></td>\n\
                    </tr>\n\
                    {{/with}}\n\
                    {{/if}}\n\
                    {{#if CardValidUntil}}\n\
                    ...
                    <tr>\n\
                        <th style=\"width:80px;\">{{Name}}</th>\n\
                        <td class=\"J_tplbirthday\">{{../../birthdayY}}-{{../../birthdayM}}-{{../../birthdayD}}</td>\n\
                    </tr>\n\
                    {{/with}}\n\
                    {{/if}}\n\
                    {{#if BirthPlace}}\n\
    ...
    <div class=\"\" style=\"float: right;width: 250px;padding-top: 25px;border-left: 1px dotted #dcdcdc;margin-left: -1px\">\n\
        <a href=\"#\" class=\"btn_blue J_infoup\" style=\"margin:0 auto 15px;display:none\" target=\"_blank\"></a>\n\
    </div>\n\
</div>\n\
"});